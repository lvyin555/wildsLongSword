...
- 我改的：
  ...
  11. 荒野的红刃机制，气刃强制为满，并有回气buff（特效），气刃大回旋斩与居合拔刀气刃斩共可增加三次20%刃色，看破斩消耗20%刃色，判定成功同时回砍命中增加10%，红刃掉刃失去所有气刃与回气buff（暂时未移除其他刃色登龙的回气buff）（由于没做炼气解放无双斩与赤刃（赤刃招式不考虑添加）系列招式，因此默认关闭，若需要，请将config.json文件中将RS的值修改为1）
